(function($) {	
	...
	{		
		...
		$(document).on("mouseenter", "#adminmenuwrap", function(event){
			$('#adminmenusuperwrap').width( window.menuWidth + parseInt($('.wp-submenu.wp-submenu-wrap', this).width()) + 10 );
		});
	
		$(document).on("mouseleave", "#adminmenuwrap", function(event){
